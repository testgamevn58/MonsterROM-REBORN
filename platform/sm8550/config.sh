...
# Platform configuration file for Qualcomm Snapdragon 8 Gen 2 for Galaxy (sm8550)
...
TARGET_SYSTEM_PARTITION_SIZE=8589934592
TARGET_SYSTEM_DLKM_PARTITION_SIZE=134217728
TARGET_PRODUCT_PARTITION_SIZE=1610612736
TARGET_VENDOR_PARTITION_SIZE=2469396480
TARGET_VENDOR_DLKM_PARTITION_SIZE=104857600
TARGET_ODM_PARTITION_SIZE=33554432
TARGET_SYSTEM_EXT_PARTITION_SIZE=536870912
